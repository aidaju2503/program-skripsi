				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
								<div class="tittle-head">
									<h4 class="latest-text">LIST OF TRAILER FILMS </h4>
									<div class="container">
						...
						<div class="blog-pagenat-wthree">
                            ...
                            <ul>
	                          <?php
	                              ...
	                              $aktif = $i;
	                          ?>
								<li><a href="beranda.php?halaman=<?php echo $i; ?>" class="<?php if($halamannya == $aktif){ echo"frist"; }else{ echo"btn-default"; } ?>"><?php echo $i; ?></a></li>
