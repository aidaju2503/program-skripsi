				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
								<div class="tittle-head">
									<h4 class="latest-text">Genre - <small><?php echo $_GET['genre'] ?></small></h4>
									<div class="container">
							...
							<div class="browse-inner">
                                ...
                                $result  = mysqli_query($koneksi,"SELECT * FROM tb_film where genre = '$genre' order by id asc");
                                $total   = mysqli_num_rows($result);
                                $pages   = ceil($total/$halaman);

                                $data = mysqli_query($koneksi,"SELECT * FROM tb_film where genre = '$genre' order by id ASC LIMIT $mulai, $halaman");
						...
						<div class="blog-pagenat-wthree">
                            ...
                            <ul>
	                          <?php
	                              ...
	                              $aktif = $i;
	                          ?>
								<li><a href="genre.php?genre=<?php echo $_GET['genre'] ?>&halaman=<?php echo $i; ?>" class="<?php if($halamannya == $aktif){ echo"frist"; }else{ echo"btn-default"; } ?>"><?php echo $i; ?></a></li>
