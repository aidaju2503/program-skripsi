...
function cekKamus($kata){ 
	...
	$sql = mysqli_query($koneksi,"SELECT * from tb_kata_dasar where kata_dasar ='$kata' LIMIT 1");
	// $sql = mysqli_query($koneksi,"SELECT * from tb_kata_dasar where kata_dasar ='$kata' LIMIT 1")or die (mysqli_error($koneksi));
