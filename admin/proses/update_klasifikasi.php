 <?php
	...
	//ambil hasil cosine similarity yang terbesar

	$id_data_uji = $_POST['id'];
	$id_film     = $_POST['id_film'];
	$komentar    = $_POST['komentar'];
    ...
    while($row    = mysqli_fetch_array($ambil_hasil_cosine_similarity_terbesar))
    {
        ...
        //updtae hasil terakhir di tb_data_uji
        $update = mysqli_query($koneksi,"UPDATE tb_data_uji SET id_film = $id_film, data_uji = '$komentar', id_data_training = $id_data_training, cosine_similarity = $cosine_similarity WHERE id = $id_data_uji ")  or die(mysqli_error()); 
    }

	echo "<script> document.location.href='../hasil_klasifikasi.php?pesan=edit_sukses'; </script>";	
